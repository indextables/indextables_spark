...
### Token Length Limits (for text fields)
Configure the maximum token length for text fields. Tokens longer than this limit are **filtered out** (not truncated) during tokenization. This prevents excessively long tokens from consuming index space.
...
spark.indextables.indexing.tokenLength.255: "content,body"      // 255 for content and body
spark.indextables.indexing.tokenLength.legacy: "short_content"  // 40 for short_content
spark.indextables.indexing.tokenLength.tantivy_max: "url,base64" // 65530 for URLs and base64
