 ...
 * 
 * This class registers custom parsers, optimizers, and other extensions
 * with Spark to enable Tantivy4Spark-specific functionality.
 * 
 * Extensions provided:
 ...
 * spark.sql.extensions=com.tantivy4spark.extensions.Tantivy4SparkExtensions
 */
