...
/**
 * Real Azure Blob Storage integration tests for SYNC INDEXTABLES TO DELTA.
 *
 * These tests require:
...
class RealAzureSyncToExternalTest extends RealAzureTestBase {
  ...
  test("SYNC INDEXTABLES TO DELTA should parse with Azure paths") {
    val result = spark.sql(
      s"SYNC INDEXTABLES TO DELTA 'abfss://container@account.dfs.core.windows.net/delta' " +
