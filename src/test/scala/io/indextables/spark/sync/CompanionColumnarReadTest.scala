...
/**
 * Integration tests for the Arrow FFI columnar read path (ColumnarPartitionReader).
 *
 * Tests verify that columnar reads produce correct results. Coverage includes:
