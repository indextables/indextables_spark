 ...
 */
class CloudS3PostCommitMergeOnWriteTest extends CloudS3TestBase {

  private val logger = org.slf4j.LoggerFactory.getLogger(classOf[CloudS3PostCommitMergeOnWriteTest])
