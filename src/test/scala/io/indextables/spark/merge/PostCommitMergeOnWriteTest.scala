 ...
 *   1. Writes splits normally to final location 2. Commits transaction log 3. Evaluates if merge is worthwhile based on
 *      merge group count vs threshold 4. Invokes MERGE SPLITS command if threshold is met
 */
