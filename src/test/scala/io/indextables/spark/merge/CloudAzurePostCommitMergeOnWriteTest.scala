 ...
 */
class CloudAzurePostCommitMergeOnWriteTest extends CloudAzureTestBase {

  private val logger = org.slf4j.LoggerFactory.getLogger(classOf[CloudAzurePostCommitMergeOnWriteTest])
