...
class NumericFieldFilteringTest extends TestBase {
  ...
  test("Comprehensive numeric field filtering test") {
    ...
    withTempPath { testPath =>
      ...
      ageResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Age: ${row.getAs[Int]("age")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      ageGreaterResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Age: ${row.getAs[Int]("age")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      salaryResults.toList.foreach(row =>
        println(
          s"  - ID: ${row.getAs[Int]("id")}, Salary: ${row.getAs[Long]("salary")}, Name: ${row.getAs[String]("name")}"
        )
      )
      ...
      salaryRangeResults.toList.foreach(row =>
        println(
          s"  - ID: ${row.getAs[Int]("id")}, Salary: ${row.getAs[Long]("salary")}, Name: ${row.getAs[String]("name")}"
        )
      )
      ...
      scoreResults.toList.foreach(row =>
        println(
          s"  - ID: ${row.getAs[Int]("id")}, Score: ${row.getAs[Double]("score")}, Name: ${row.getAs[String]("name")}"
        )
      )
      ...
      ratingResults.toList.foreach(row =>
        println(
          s"  - ID: ${row.getAs[Int]("id")}, Rating: ${row.getAs[Float]("rating")}, Name: ${row.getAs[String]("name")}"
        )
      )
      ...
      activeResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Active: ${row.getAs[Boolean]("active")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      ageInResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Age: ${row.getAs[Int]("age")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      complexAndResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Age: ${row.getAs[Int]("age")}, Active: ${row.getAs[Boolean]("active")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      deptResults.toList.foreach(row =>
        println(s"  - ID: ${row.getAs[Int]("id")}, Department: ${row.getAs[String]("department")}, Name: ${row.getAs[String]("name")}")
      )
      ...
      assert(
        dfApiResults == sqlResults,
        s"DataFrame API ($dfApiResults) and SQL API ($sqlResults) should return same count"
      )
