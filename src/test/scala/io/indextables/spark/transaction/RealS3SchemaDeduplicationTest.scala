 ...
 */
class RealS3SchemaDeduplicationTest extends RealS3TestBase {
  ...
  override def beforeAll(): Unit = {
    ...
    if (awsCredentials.isDefined) {
      ...
      println(s"📦 RealS3SchemaDeduplicationTest: Configured for S3 bucket $S3_BUCKET in region $S3_REGION")
    }
  }
