 ...
 *
 * Run with: mvn test -DwildcardSuites='io.indextables.spark.transaction.avro.CloudAzureAvroStateLifecycleTest'
 *
 * Configure container via system property: -Dtest.azure.container=your-test-container
 */
class CloudAzureAvroStateLifecycleTest extends CloudAzureTestBase {
