 ...
 *
 * Run with: mvn scalatest:test -DwildcardSuites='io.indextables.spark.transaction.avro.CloudS3AvroStateLifecycleTest'
 */
class CloudS3AvroStateLifecycleTest extends CloudS3TestBase {

  private val provider = "io.indextables.spark.core.IndexTables4SparkTableProvider"

  // Use same bucket and region as other CloudS3 tests
