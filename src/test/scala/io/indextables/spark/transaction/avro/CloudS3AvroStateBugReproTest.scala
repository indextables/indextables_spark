 ...
 *
 * Run with: mvn scalatest:test -DwildcardSuites='io.indextables.spark.transaction.avro.CloudS3AvroStateBugReproTest'
 */
class CloudS3AvroStateBugReproTest extends CloudS3TestBase {
