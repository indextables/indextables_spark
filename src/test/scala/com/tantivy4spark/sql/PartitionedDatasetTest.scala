...
class PartitionedDatasetTest extends TestBase {
  ...
  test("V1 vs V2 write path compatibility with partitioned MERGE SPLITS") {
    ...
    // Test V2 path (com.tantivy4spark.core.Tantivy4SparkTableProvider)
    println("Testing V2 path: format('com.tantivy4spark.core.Tantivy4SparkTableProvider')")
    testData.write
    ...
    val dfV2 = spark.read.format("com.tantivy4spark.core.Tantivy4SparkTableProvider").load(testDataV2)
