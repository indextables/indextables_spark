...
package com.tantivy4spark.testutils
...
import software.amazon.awssdk.auth.credentials.{AwsCredentials, AwsCredentialsProvider, AwsBasicCredentials, AwsSessionCredentials}

/**
 * Test implementation of AWS SDK v1 AWSCredentialsProvider.
 * This class uses real AWS SDK v1 interfaces for proper testing.
 */
...
/**
 * Test implementation of AWS SDK v2 AwsCredentialsProvider.
 * This class uses real AWS SDK v2 interfaces for proper testing.
 */
...
/**
 * Test credential provider that implements both v1 and v2 interfaces.
 * This is useful for testing interface detection logic and ensuring
 * our reflection code properly handles both SDK versions.
 */
class TestDualCredentialProvider(uri: URI, conf: Configuration)
  extends AWSCredentialsProvider with AwsCredentialsProvider {
