...
/**
 * Test to demonstrate the credential propagation issue in V2 read path.
 * Specifically tests that AWS credentials are properly passed from driver to executors
 * when using SplitSearchEngine.fromSplitFile in Tantivy4SparkPartitionReader.
 */
