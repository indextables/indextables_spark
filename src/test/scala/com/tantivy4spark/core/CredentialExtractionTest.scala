...
/**
 * Test to verify that credential extraction logic in Tantivy4SparkRelation works correctly.
 * This test validates the actual credential values are properly extracted from different sources.
 */
