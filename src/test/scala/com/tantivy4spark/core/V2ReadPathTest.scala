...
/**
 * Focused test for V2 DataSource API read path to ensure no serialization issues.
 * This test specifically checks the V2 path that was missing from other test coverage.
 */
    ...
    withTempPath { tempPath =>
      ...
      try {
        val readDataV2 = spark.read
          .format("com.tantivy4spark.core.Tantivy4SparkTableProvider")  // V2 Provider explicitly
          .load(tempPath)
