...
1. **Install the JAR**: Add the platform-specific [IndexTables JAR](https://repo1.maven.org/maven2/io/indextables/indextables_spark/0.3.0_spark_3.5.3/indextables_spark-0.3.0_spark_3.5.3-linux-x86_64-shaded.jar) to the boot classpath for both executors and driver
